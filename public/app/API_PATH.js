...
_API_PATH.sendEmail   = window._env.api_url +'email-customer'; 
//[PUT] sendEmail to customer from CRM
...
_API_PATH.getUser   = window._env.api_url +'get-user'; 
//[GET] get single user

_API_PATH.updateTask = window._env.api_url +'update-task';
//[GET] update single user

_API_PATH.adminupdateTask = window._env.api_url +'admin-update-task';
//[GET] update admin user

_API_PATH.getAdminUser = window._env.api_url +'get-admin-user';
//[GET] get admin user
/**
 * Settings
 */
