...
class AppRouter {
    ...
    loadAppRoutes(){
        ...
        this.router.get('/get-user', this.call['frontend']['UserController'].oneUser);
        
        this.router.post('/update-task', this.call['frontend']['UserController'].updateTask);
        this.router.post('/admin-update-task', this.call['frontend']['UserController'].adminupdateTask);
        this.router.get('/get-admin-user', this.call['frontend']['UserController'].adminUser);
        ...
        this.router.post('/email-customer',this.call['frontend']['CustomerController'].sendEmail);
        /*Manage Leads*/
